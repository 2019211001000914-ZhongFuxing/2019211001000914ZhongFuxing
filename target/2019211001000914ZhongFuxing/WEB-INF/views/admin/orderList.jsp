			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.zhongfuxing.model.Order o=(com.zhongfuxing.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.zhongfuxing.dao.UserDao userDao=new com.zhongfuxing.dao.UserDao();
						...
						<td class="cart_total">${o.payment}
						<%
							int n=o.getPaymentId();
							String paymentType=com.zhongfuxing.model.Payment.findByPaymentId(con,n);
							 %>
