<%@ page import="com.zhongfuxing.model.Product" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<%
								com.zhongfuxing.model.Product p=(Product)pageContext.findAttribute("p");
								int pid=p.getProductId();
								java.sql.Connection con = (Connection) application.getAttribute("con");
								String catName = com.zhongfuxing.model.Category.findByCaterotyId(con,pid);
							%>
							...
							<a class="cart_quantity_delete" href="<%=basePath%>admin/productDelete?productId=1${p.productId}">
